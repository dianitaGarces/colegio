...
import com.colegio.prueba.repository.CursoRepository;
import com.colegio.prueba.service.dto.CursoDTO;
import com.colegio.prueba.service.mapper.CursoMapper;
...
class CursoResourceIT {
    ...
    private static final Integer DEFAULT_GRADO = 1;
    private static final Integer UPDATED_GRADO = 2;
    ...
    public static Curso createEntity(EntityManager em) {
        Curso curso = new Curso().salon(DEFAULT_SALON).grado(DEFAULT_GRADO);
        return curso;
    }
    ...
    public static Curso createUpdatedEntity(EntityManager em) {
        Curso curso = new Curso().salon(UPDATED_SALON).grado(UPDATED_GRADO);
        return curso;
    }
    ...
    void createCurso() throws Exception {
        ...
        assertThat(testCurso.getSalon()).isEqualTo(DEFAULT_SALON);
    ...
    @Test
    @Transactional
    void checkSalonIsRequired() throws Exception {
    ...
    void putNewCurso() throws Exception {
        ...
        updatedCurso.salon(UPDATED_SALON).grado(UPDATED_GRADO);
        ...
        Curso testCurso = cursoList.get(cursoList.size() - 1);
        assertThat(testCurso.getSalon()).isEqualTo(UPDATED_SALON);
    ...
    void partialUpdateCursoWithPatch() throws Exception {
        ...
        partialUpdatedCurso.salon(UPDATED_SALON).grado(UPDATED_GRADO);
